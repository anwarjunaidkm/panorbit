...
export const ChatShow = ({toggleChat,toggleChatScreen}) => {
  return (
    <div>
        ...
        <Card  className="chat-show-card">
            ...
            <div className="chat-parent" >
                ...
                <h3 className='chat-name-small'><Link className='link' onClick={toggleChatScreen}> Anwarjunaid</Link></h3>
                    </div>
            ...
            <div className="chat-parent" >
                ...
                <img className='chat-icon-small' src={aj} alt="" />
                <h3 className='chat-name-small'>Anwarjunaid</h3>
                    </div>
